...
for _, name in ipairs({"nullius-pump-1-pneumatic", "nullius-pump-2-pneumatic",
  "nullius-togglable-pump-1-pneumatic",
...
for _,name in ipairs(names) do
  ...
  if modern then
    assert(source.fluid_wagon_connector_frame_count == nil, "obsolete connector frame count: " .. name)
    ...
    assert(source.fluid_wagon_connector_frame_count == 35, "legacy connector frames: " .. name)

-- Three separate finite fluid feeds; outputs stay in the machine.
local categories={"small-crafting","large-assembly","medium-only-assembly","hand-casting",
  "machine-casting","hand-crafting","basic-chemistry","nanotechnology","large-crafting"}
for _,category in ipairs(categories) do
  local machine=table.deepcopy(data.raw["assembling-machine"]["assembling-machine-2"])
  machine.name="factorio-test-weapon-"..category
  machine.minable=nil
  ...
  machine.fluid_boxes[4]={production_type="output",volume=10000,

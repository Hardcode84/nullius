...
local categories={"huge-assembly","huge-crafting","large-assembly","large-crafting","large-fluid-assembly","medium-crafting","medium-only-assembly","nanotechnology","small-crafting","small-fluid-assembly","tiny-assembly","tiny-crafting","factorio-test-building-rejected"}
data:extend({{type="recipe-category",name="factorio-test-building-rejected"}})
for _,category in ipairs(categories) do
  local machine=table.deepcopy(data.raw["assembling-machine"]["assembling-machine-2"])
  machine.name="factorio-test-building-"..category
  machine.minable=nil
...
buffer.name="factorio-test-building-buffer"

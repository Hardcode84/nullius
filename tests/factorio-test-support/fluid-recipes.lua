...
data:extend({{type="recipe-category",name="factorio-test-fluid-rejected"}})
local variants={["factorio-test-fluid-rejected"]={category="factorio-test-fluid-rejected",inputs=0,outputs=0}}
...
for name,variant in pairs(variants) do
  ...
  machine.name="factorio-test-fluid-"..name
  machine.minable=nil

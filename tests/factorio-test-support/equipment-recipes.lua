...
local categories={"basic-chemistry","hand-casting","huge-assembly","huge-crafting","huge-fluid-assembly","large-assembly","large-crafting","large-fluid-assembly","machine-casting","medium-crafting","medium-only-assembly","nanotechnology","nullius-electrolysis","rocketry","small-crafting","small-fluid-assembly","tiny-crafting","factorio-test-equipment-rejected"}
data:extend({{type="recipe-category",name="factorio-test-equipment-rejected"}})
for _,category in ipairs(categories) do
  local machine=table.deepcopy(data.raw["assembling-machine"]["assembling-machine-2"])
  machine.name="factorio-test-equipment-"..category
  machine.minable=nil
...
buffer.name="factorio-test-equipment-buffer"

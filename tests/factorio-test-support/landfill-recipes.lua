...
local categories={"hand-crushing","ore-crushing","ore-flotation","bulk-smelting","tiny-crafting"}
for _,category in ipairs(categories) do
  local machine=table.deepcopy(data.raw["assembling-machine"]["assembling-machine-2"])
  machine.name="factorio-test-landfill-"..category
  machine.minable=nil
...
buffer.name="factorio-test-landfill-buffer"

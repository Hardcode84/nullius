local CASE = "thermal-engineering-1"
...
local function terminal_check()
  ...
  check(force.technologies[TECHNOLOGY].researched,
    "Thermal Engineering 1 was not researched")
...
local function start_research()
  ...
  check(force.add_research(force.technologies[TECHNOLOGY]),
    "Factorio refused to start Thermal Engineering 1")
  check(force.current_research == force.technologies[TECHNOLOGY],
    "Thermal Engineering 1 is not current research")
...
local function setup()
  ...
  check(technology ~= nil, "missing Thermal Engineering 1 technology")

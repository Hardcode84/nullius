...
| Entity prototypes | Chest robot doors, mining-drill graphics, and crafting symmetry changed | Port each entity family; check graphics and fluid port geometry |

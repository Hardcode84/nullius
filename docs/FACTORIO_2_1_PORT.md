...
| Terrain-drone recipe categories | Five terraforming and ten paving recipes select the native schema | Both engines craft all 15 with exact bulk inputs, color mappings, outputs, and times. Full Nullius 2.0 also checks research unlocks |

...
| Water quenching | Hot metalworking and experimental chemistry are available | Water increases iron plate yield. Pneumatic inserters remove cooled blooms and restart the line after a water outage. | `vulcanus-water-quenching` | `vulcanus-water-quenching.args` |

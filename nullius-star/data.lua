...
require("prototypes.planet.thermal-nanofabricators")
require("prototypes.entity.miner")
require("prototypes.entity.plumbing")
require("prototypes.planet.vulcanus-entities")
...
require("prototypes.planet.primitive-robotics-entities")
...
require("prototypes.planet.vulcanus-technology")
require("prototypes.planet.vulcanus-tips")
require("prototypes.autocraft-tips")
require("prototypes.checkpoint")
require("prototypes.upgrades")
require("prototypes.planet.vulcanus-mining-productivity")

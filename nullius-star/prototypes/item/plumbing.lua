...
local function extend_plumbing_prototypes(prototypes)
  if not modern then
...
extend_plumbing_prototypes({
  ...
  },
  {
    ...
    ingredients = {
      ...
      {type = "item", name = "nullius-air-filter-2", amount = 1},
      {type = "item", name = "nullius-large-tank-2", amount = 1},
      {type = "item", name = "nullius-one-way-valve", amount = 6},
...

  {
    ...
    subgroup = "heat-energy",
    order = "nullius-be",
    place_result = "nullius-temperature-sensor",
    stack_size = 50
  },
  {
    type = "recipe",

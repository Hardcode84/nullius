...
data:extend({
  ...
  },
  {
    ...
    localised_description = {"technology-description.nullius-alternative",
	    {"technology-description.nullius-produce",
	      {"technology-description.nullius-item", tostring(1000), "nullius-sandstone",
	        {"item-name.nullius-sandstone"}}},
	    {"technology-description.nullius-produce",
	      {"technology-description.nullius-item", tostring(800), "nullius-sand",
	        {"item-name.nullius-sand"}}}},
    order = "nullius-yc",
    icons = {
  ...
  },
  {
    ...
    localised_description = {"technology-description.nullius-alternative",
	    {"technology-description.nullius-produce",
	      {"technology-description.nullius-item", tostring(2000), "nullius-bauxite",
	        {"item-name.nullius-bauxite"}}},
	    {"technology-description.nullius-produce",
	      {"technology-description.nullius-item", tostring(800), "nullius-molten-aluminum-bloom",
	        {"item-name.nullius-molten-aluminum-bloom"}}}},
    order = "nullius-yc",
    icons = {

...
local checkpoint_data = {
  ...
  ["iron-ore"] = {{ CHK_ITEM, STT_PRODUCE, 400,
			{{"iron-ore"}, {"nullius-molten-iron-bloom", 2.5}} }},
  ...
  ["limestone"] = {{ CHK_ITEM, STT_PRODUCE, 500,
			{{"nullius-limestone"}, {"nullius-crushed-limestone", 25 / 16}} }},

local CASE = "vulcanus-construction-closure"
local RESULT = "factorio-tests/" .. CASE .. ".json"
local CONTRACT = require("manifest")
...
advance = function()
  ...
  if not selected_index then
    check(false, "construction manifest reached a material or executor deadlock")
    finish()
    return
  end
...
local function deadline()
  ...
  local active = storage.active
  check(false, "construction closure exceeded tick budget; completed_steps=" ..
